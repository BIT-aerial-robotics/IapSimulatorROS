...
StatesSender::StatesSender(const ros::NodeHandle& _nodeHandle,
  ...
  : nodeHandle_(_nodeHandle),
    ...
    imuNo0_(_timeStep), imuNo1_(_timeStep), imuNo2_(_timeStep), imuNo3_(_timeStep),
    imuNoNoise0_(_timeStep), imuNoNoise1_(_timeStep), imuNoNoise2_(_timeStep), imuNoNoise3_(_timeStep)
{
...
void StatesSender::getAndSendStates(AvaRobotState& _states)
{
    ...
    // child drone 1 quaternion to base
    Eigen::Quaterniond quaternion3_0;
    ...
    Eigen::Matrix3d matrix1_origin = getRotationMatrix(originalEulerAngle1_);
    // original rotation from drone 2 to base frame
    Eigen::Matrix3d matrix2_origin = getRotationMatrix(originalEulerAngle2_);
    // original rotation from drone 3 to base frame
    Eigen::Matrix3d matrix3_origin = getRotationMatrix(originalEulerAngle3_);
    ...
    // child drone 3 frame rotation to joint3
    Eigen::Matrix3d matrix3_0;
    ...
    // child drone 3 frame rotation to world frame
    ...
    // child drone 3 position in world frame
    ...
    // child drone 3 angular velocity to joint3 in joint3 frame
    Eigen::Vector3d bodyRate3_0;
    // base body rate
    ...
    // child drone 3 body rate
    Eigen::Vector3d bodyRate3;
    raisim::Vec<3> bodyRate3_r;
    ...
    // child drone 1 velocity in world frame
    Eigen::Vector3d velocity3_w;
    raisim::Vec<3> velocity3_r;
    // child drone 1 velocity in child drone 1 frame
    ...
    Eigen::Vector3d linearAcceleration3;
    ...
    quaternion3_0.w() = jointStates[15];
    quaternion3_0.x() = jointStates[16];
    quaternion3_0.y() = jointStates[17];
    quaternion3_0.z() = jointStates[18];
    ...
    bodyRate3_0.x() = jointVelocities[12];
    bodyRate3_0.y() = jointVelocities[13];
    bodyRate3_0.z() = jointVelocities[14];
    ...
    robot_->getFrameVelocity(std::string("Uav3_joint"), velocity3_r);
    ...
    eulerAngle3_0 = getEulerAngle(quaternion3_0);
    ...
    eulerAngle3_0 = convertFromFluToFrd(eulerAngle3_0);
    ...
    else
    {
      ...
      // linearAcceleration3 = (velocity3 - velocityLast3_) / timeStep_ + bodyRate3.cross(velocity3) - g * matrix3.transpose() * e3;
      ...
      linearAcceleration3 = matrix3.transpose() * ((velocity3_w - velocityLast3_) / timeStep_ - g * e3);
    ...
    position1 = matrix0 * relativePosition1_ + position0;
    position2 = matrix0 * relativePosition2_ + position0;
    position3 = matrix0 * relativePosition3_ + position0;
    ...
    DataProtocol::Data eulerAngleData3x(eulerAngle3.x(), 0);
    DataProtocol::Data eulerAngleData3y(eulerAngle3.y(), 1);
    DataProtocol::Data eulerAngleData3z(eulerAngle3.z(), 2);
    DataProtocol::DataPacket eulerAnglePack3;
    eulerAnglePack3.addData(eulerAngleData3x);
    eulerAnglePack3.addData(eulerAngleData3y);
    eulerAnglePack3.addData(eulerAngleData3z);
    ...
    DataProtocol::Data bodyRateData3x(bodyRate3.x(), 0);
    DataProtocol::Data bodyRateData3y(bodyRate3.y(), 1);
    DataProtocol::Data bodyRateData3z(bodyRate3.z(), 2);
    DataProtocol::DataPacket bodyRatePack3;
    bodyRatePack3.addData(bodyRateData3x);
    bodyRatePack3.addData(bodyRateData3y);
    bodyRatePack3.addData(bodyRateData3z);
    ...
    DataProtocol::Data velocityData3x(velocity3.x(), 0);
    DataProtocol::Data velocityData3y(velocity3.y(), 1);
    DataProtocol::Data velocityData3z(velocity3.z(), 2);
    DataProtocol::DataPacket velocityPack3;
    velocityPack3.addData(velocityData3x);
    velocityPack3.addData(velocityData3y);
    velocityPack3.addData(velocityData3z);
    ...
    DataProtocol::Data linearAccelerationData3x(linearAcceleration3.x(), 0);
    DataProtocol::Data linearAccelerationData3y(linearAcceleration3.y(), 1);
    DataProtocol::Data linearAccelerationData3z(linearAcceleration3.z(), 2);
    DataProtocol::DataPacket linearAccelerationPack3;
    linearAccelerationPack3.addData(linearAccelerationData3x);
    linearAccelerationPack3.addData(linearAccelerationData3y);
    linearAccelerationPack3.addData(linearAccelerationData3z);
    ...
    statesPack.addData(velocityPack3, 12);
    ...
    statesPack.addData(linearAccelerationPack3, 16);

    Eigen::Vector3d contactForcesWorld;
    Eigen::Vector3d contactMomentsWorld;
    for (auto& contact: robot_->getContacts())
    {
      ...
      if (_states.toolIndex == contact.getlocalBodyIndex())
      {
        ...
        {
          Eigen::Vector3d contactForceWorld = convertFromFluToFrd(contact.getContactFrame().e().transpose() * impulseOnA / timeStep_);
          Eigen::Vector3d contactMomentWorld = contact.getPosition().e().cross(contactForceWorld);

          contactForcesWorld += contactForceWorld;
          contactMomentsWorld += contactMomentWorld;
        }
      }
    }

    DataProtocol::Data contactForceWorldData0x(contactForcesWorld.x(), 0);
    DataProtocol::Data contactForceWorldData0y(contactForcesWorld.y(), 1);
    DataProtocol::Data contactForceWorldData0z(contactForcesWorld.z(), 2);
    DataProtocol::DataPacket contactForceWorldPack;
    contactForceWorldPack.addData(contactForceWorldData0x);
    contactForceWorldPack.addData(contactForceWorldData0y);
    contactForceWorldPack.addData(contactForceWorldData0z);
    DataProtocol::Data contactMomentWorldData0x(contactMomentsWorld.x(), 0);
    DataProtocol::Data contactMomentWorldData0y(contactMomentsWorld.y(), 1);
    DataProtocol::Data contactMomentWorldData0z(contactMomentsWorld.z(), 2);
    DataProtocol::DataPacket contactMomentWorldPack;
    contactMomentWorldPack.addData(contactMomentWorldData0x);
    contactMomentWorldPack.addData(contactMomentWorldData0y);
    contactMomentWorldPack.addData(contactMomentWorldData0z);

    Eigen::Vector3d contactForces = matrix0.transpose() * contactForcesWorld;
    Eigen::Vector3d contactMoments = matrix0.transpose() * contactMomentsWorld;
    ...
    statesPack.addData(contactForceWorldPack, 17);
    statesPack.addData(contactMomentWorldPack, 18);
    statesPack.addData(contactForcePack, 20);
    statesPack.addData(contactMomentPack, 21);
    ...
    publishRosVector(eulerAnglePublisherNo3_, eulerAngle3, eulerAngleMessageNo3_);
    ...
    publishRosVector(bodyRatePublisherNo3_, bodyRate3, bodyRateMessageNo3_);
    ...
    publishRosVector(positionPublisherNo3_, position3, positionMessageNo3_);
    ...
    publishRosVector(velocityPublisherNo3_, velocity3, velocityMessageNo3_);
    ...
    publishRosVector(linearAccelerationPublisherNo3_, linearAcceleration3, linearAccelerationMessageNo3_);
    publishRosVector(contactForceWorldPublisherNo0_, contactForcesWorld, contactForceWorldMessage_);
    publishRosVector(contactMomentWorldPublisherNo0_, contactMomentsWorld, contactMomentWorldMessage_);
    ...
    poseMessageNo3_.header.stamp = imuTimeNow;
    ...
    publishRosPose(posePublisherNo3_, position3, Eigen::Quaterniond(matrix3), poseMessageNo3_);
    ...
    linearAcceleration3 = convertFromFluToFrd(linearAcceleration3);
    ...
    imuNo3_.updateDataWithNoise(bodyRate3, linearAcceleration3);
    ...
    imuMessageNo3_.header.stamp = imuTimeNow;
    imuMessageNo3_.orientation = poseMessageNo3_.pose.pose.orientation;
    ...
    publishRosImu(imuPublisherNo3_, imuNo3_, imuMessageNo3_, currentTime);
    ...
    imuNoNoiseMessageNo3_.header.stamp = imuTimeNow;
    imuNoNoiseMessageNo3_.orientation = poseMessageNo3_.pose.pose.orientation;
    ...
    imuNoNoise3_.dataOmega = bodyRate3;
    imuNoNoise3_.dataAcc = linearAcceleration3;
    ...
    publishRosImu(imuNoNoisePublisherNo3_, imuNoNoise3_, imuNoNoiseMessageNo3_, currentTime);
    ...
    bag_.write("/imu_no_noise_3", imuTimeNow, imuNoNoiseMessageNo3_);
    ...
    bag_.write("/euler_angle_3", imuTimeNow, eulerAngleMessageNo3_);
    bag_.write("/velocity_0", imuTimeNow, velocityMessageNo0_);
    bag_.write("/body_rate_0", imuTimeNow, bodyRateMessageNo0_);
    ...
    bag_.write("/imu_3", imuTimeNow, imuMessageNo3_);
    ...
    bag_.write("/pose_3", imuTimeNow, poseMessageNo3_);
    bag_.write("/external_force", imuTimeNow, contactForceMessage_);
    bag_.write("/external_moment", imuTimeNow, contactMomentMessage_);
    bag_.write("/external_force_world", imuTimeNow, contactForceWorldMessage_);
    bag_.write("/external_moment_world", imuTimeNow, contactMomentWorldMessage_);
    ...
    // bag_.write("/linear_acceleration_3", imuTimeNow, linearAccelerationMessageNo3_);

    // writes states to structure
    _states.rotation0_w = matrix0;
    _states.rotation1_0 = matrix1_0;
    _states.rotation2_0 = matrix2_0;
    _states.rotation3_0 = matrix3_0;
    _states.eulerAngle0 = eulerAngle0;
    _states.eulerAngle1 = eulerAngle1;
    _states.eulerAngle2 = eulerAngle2;
    _states.eulerAngle3 = eulerAngle3;
    _states.position0 = position0;
    _states.position1 = position1;
    _states.position2 = position2;
    _states.position3 = position3;
    _states.bodyRate0 = convertFromFluToFrd(bodyRate0);
    _states.bodyRate1 = convertFromFluToFrd(bodyRate1);
    _states.bodyRate2 = convertFromFluToFrd(bodyRate2);
    _states.bodyRate3 = convertFromFluToFrd(bodyRate3);
    _states.velocity0 = velocity0;
    _states.velocity1 = velocity1;
    _states.velocity2 = velocity2;
    _states.velocity3 = velocity3;
    _states.linearAcceleration0 = convertFromFluToFrd(linearAcceleration0);
    _states.linearAcceleration1 = convertFromFluToFrd(linearAcceleration1);
    _states.linearAcceleration2 = convertFromFluToFrd(linearAcceleration2);
    _states.linearAcceleration3 = convertFromFluToFrd(linearAcceleration3);
}
...
void StatesSender::initializeRosPublishers()
{
    ...
    eulerAnglePublisherNo3_ = nodeHandle_.advertise<geometry_msgs::Point>
                              (robot_->getName() + "/euler_angle_3", 10);
    ...
    bodyRatePublisherNo3_   = nodeHandle_.advertise<geometry_msgs::Point>
                              (robot_->getName() + "/body_rate_3", 10);
    ...
    positionPublisherNo3_   = nodeHandle_.advertise<geometry_msgs::Point>
                              (robot_->getName() + "/position_3", 10);
    ...
    velocityPublisherNo3_   = nodeHandle_.advertise<geometry_msgs::Point>
                              (robot_->getName() + "/velocity_3", 10);
    ...
    posePublisherNo3_       = nodeHandle_.advertise<nav_msgs::Odometry>
                              (robot_->getName() + "/pose_3", 10);
    ...
    linearAccelerationPublisherNo3_ = nodeHandle_.advertise<geometry_msgs::Point>
                                      (robot_->getName() + "/linear_acceleration_3", 10);
    ...
    imuPublisherNo3_           = nodeHandle_.advertise<sensor_msgs::Imu>
                                 (robot_->getName() + "/imu_3", 10);
    ...
    imuNoNoisePublisherNo3_    = nodeHandle_.advertise<sensor_msgs::Imu>
                                 (robot_->getName() + "/imu_no_noise_3", 10);
    contactForcePublisherNo0_  = nodeHandle_.advertise<geometry_msgs::Point>
                                 (robot_->getName() + "/external_force", 10);
    contactMomentPublisherNo0_ = nodeHandle_.advertise<geometry_msgs::Point>
                                 (robot_->getName() + "/external_moment", 10);
    contactForceWorldPublisherNo0_  = nodeHandle_.advertise<geometry_msgs::Point>
                                      (robot_->getName() + "/external_force_world", 10);
    contactMomentWorldPublisherNo0_ = nodeHandle_.advertise<geometry_msgs::Point>
